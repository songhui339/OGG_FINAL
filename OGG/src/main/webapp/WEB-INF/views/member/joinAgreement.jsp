        ...
        <div class="contentWrap">
            <div class="formBox">
                ...
                <form name="fregister" id="fregister" action="/member/goJoinPage.do" autocomplete="off" class="form" role="form">
                    ...
                    <h3><span class="c_purple">개인정보</span> 처리방침</h3>
                    <div class="form-round scroll">
                        <style>
                            .page-content { line-height:22px; word-break: keep-all; word-wrap: break-word; }
                            .page-content .article-title { color:#7e69fe; font-weight:bold; padding-top:30px; padding-bottom:10px; }
                    ...
                    <div class="buttonBox">
                        <button type="submit" class="button" onclick="location.href='/'">취소</button>
                        <button type="submit" class="button button-purple" id="nextBtn" name="nextBtn">회원가입</button>
                    </div>
		...
		$(document).ready(function(){
			$("#nextBtn").click(function(){    
				if($("input:checkbox[id='agree1']").is(":checked") == false){
					alert("회원가입 약관에 동의 하셔야 다음 단계로 진행 가능합니다.");
					return false;
				}else if($("input:checkbox[id='agree2']").is(":checked") == false){
					alert("개인정보처리방침을 동의 하셔야 다음 단계로 진행 가능합니다.");
					return false;
				}else{
					$("#fregister").submit();
				}
