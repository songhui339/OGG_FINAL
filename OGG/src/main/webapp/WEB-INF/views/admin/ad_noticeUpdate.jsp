                            ...
                            <!-- board list area -->
                                <div id="board-list">
                                    <div class="container">
                                        <table class="board-table">
                                            ...
                                            <!-- 
                                             ...
                                             -->
                                                ...
                                                <tr>
                                                    <th>
                                                        <input type="text" placeholder="제목을 입력하세요" name="n_title" id="writingName" value="${notice.n_title}" >
                                                    </th>
                                        ...
                                        <br>
                                        <textarea name="n_content" id="n_content" cols="30" rows="10">${notice.n_content}</textarea>
                                        <br>
                                        <div id="btn1">
                                            <input type="submit" value="수정완료" id="subBtn">
