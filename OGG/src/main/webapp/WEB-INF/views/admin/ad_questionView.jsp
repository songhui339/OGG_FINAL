...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="${path }/css/admin/questionView.css">
                            ...
                            <!-- board list area -->
                                <div id="board-list">
                                    <div class="container">
                                        ...
                                        <table id="anTB">
                                            <tr>
                                                <th id="title">&nbsp; ${answer.a_title}</th>
                                                <th id="name">${answer.a_m_name}</th>
                                                <th id="date"><fmt:formatDate type="date" value="${answer.a_date}" /></th>
                                            </tr>
                                        </table>
                                        <br>
                                        <textarea name="content" id="answer" cols="30" rows="10" readonly> ${answer.a_content}</textarea>
                                        </c:if>
                                        <br>
                                        <div id="btn1">
                                        <!-- 
