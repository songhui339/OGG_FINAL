                            ...
                            <!-- board list area -->
                                <div id="board-list">
                                    <div class="container">
                                        ...
                                        <form action="${path}/admin/answer?no=${question.q_no}" method="post">
                                        <table id="anTB">
                                            <tr>
                                                <th id="title">&nbsp; <input type="text" name="a_title" id="a_title" placeholder="제목"> </th>
                                            	<!-- 
                                        ...
                                        <br>
                                        <textarea name="a_content" id="answer" cols="30" rows="10" placeholder="답변내용입력하세요"></textarea>
                                         <div id="btn1">
                                        <!-- 
